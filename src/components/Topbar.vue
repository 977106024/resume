<template>
  <div id="topbar">
    ...
    <MyDialog title="注册" :visible="signUpDialogVisible" @close="signUpDialogVisible = false"><!--点击x时为false-->
      <SignUpForm @success="signIn($event)"/>
    </MyDialog>
    <MyDialog title="登录" :visible="signInDialogVisible" @close="signInDialogVisible = false"><!--点击x时为false-->
...
<script>
  ...
  export default {
    ...
    data(){
        return {
            signUpDialogVisible:false, //元素不可见 点击注册时为true
